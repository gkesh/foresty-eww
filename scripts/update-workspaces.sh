...
eww -c ~/.config/eww update workspaces_1_yuck="(box $box_attrs $(gib_workspace_yuck 1))"
eww -c ~/.config/eww update workspaces_2_yuck="(box $box_attrs $(gib_workspace_yuck 2))"
